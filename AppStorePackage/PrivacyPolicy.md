# Privacy Policy for IDPhoto Pro

Effective date: May 21, 2026

IDPhoto Pro is designed to help users create passport, visa, immigration, and ID photos while keeping photo processing private and local.

## 1. Photo Processing

All photo processing happens on your device. IDPhoto Pro does not upload your photos to a server for face detection, cropping, background replacement, light repair, compression, export, or creation history.
...
When you save or share an exported photo, your action is handled by iOS system services such as Photos, Files, Mail, Messages, AirDrop, or other apps you choose. Those services and apps may have their own privacy practices.
...
IDPhoto Pro 的照片处理在设备本地完成，不上传服务器。当前版本不接入广告 SDK 或第三方统计 SDK。制作记录、头像和用户名只保存在本机。内购为一次性终身解锁，不是订阅，不会自动续费。App 不隶属于任何政府、使馆、签证中心或官方申请网站，也不保证照片一定被接受；提交前请核对官方网站要求。
